    ...
    <footer className="bg-blue-900 text-white py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        {[...Array(3)].map((_, i) => (
          <div
            key={i}
            className="absolute w-64 h-64 bg-blue-800 rounded-full filter blur-3xl opacity-20 animate-pulse-slow"
            style={{
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold">iTech Club</span>
            </Link>
            <p className="text-blue-100 max-w-xs">
              Empowering the next generation of tech innovators through community, education, and hands-on experience.
            </p>
          </div>
            ...
            <div className="mt-6">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="bg-blue-800 text-white px-4 py-2 rounded-lg flex-grow"
                />
                <motion.button
        ...
        <div className="mt-16 pt-8 border-t border-blue-800 text-center text-blue-100">
          <p>© 2024 iTech Club. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
